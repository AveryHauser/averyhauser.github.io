...
def create_block_style_timeline():
    ...
    # Step 6b. Draw black rectangles for the gaps within the main grid
    ...
    # 7. Draw black header blocks for week numbers - TOROIDAL WRAPPING
    week_header_rect_height = 0.8 
    week_header_rect_y_offset = 0.1 

    # Step 6c. Add black "cap" bar to cleanly end grid
    fig.add_shape(
        type="rect",
        x0=-total_weeks * week_width, x1=total_weeks * week_width * 2,
    ...
    # Draw black rectangles for the gaps on the *label column*
    for section in category_sections:
        fig.add_shape(
            type="rect",
            xref="paper",
    ...
    # 10. Add black border around grid area (not including labels)
    fig.add_shape(
        type="rect",
        x0=-total_weeks * week_width, x1=total_weeks * week_width * 2,
        y0=0, y1=total_height,
